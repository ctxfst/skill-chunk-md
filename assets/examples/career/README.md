...
python3 scripts/build_entity_graph.py assets/examples/career/chunks.json --output assets/examples/career/entity-graph.json
```
...
- entity-to-entity similarity edges are derived later by the graph builder
